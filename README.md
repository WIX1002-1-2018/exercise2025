...
- [`W05E07.java`](Exercise2025/src/W05/W05E07.java) — Summing multiple user inputs: Keep asking for user input until a sentinel value ("done") is entered then display the sum of the inputs. (Original author: [@YudaSK](https://github.com/YudaSK))
